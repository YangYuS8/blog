---
title: "Prometheus 与 Grafana 监控实战"
urlSlug: 'prometheus-grafana-linux-monitoring-dashboard'
published: 2026-04-12
description: "从一台 Linux 服务器开始部署 node_exporter、Prometheus 与 Grafana，完成主机监控数据采集、展示与基础排查。"
image: ''
...
如果你想在一台自己的 Linux 机器上练手，这篇会比较适合直接照着做。

先把这三个项目的仓库放在这里，后面你要查版本、看文档、翻 release 都会更方便：
...
如果你用的是 Debian / Ubuntu，我更建议优先用**官方软件源**安装，这也是官方更推荐的方式之一。这样后面升级和维护都会更顺手。
