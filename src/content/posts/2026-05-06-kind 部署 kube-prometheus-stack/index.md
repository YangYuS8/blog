---
title: "kind 部署 kube-prometheus-stack"
urlSlug: 'kind-kube-prometheus-stack-monitoring-guide'
published: 2026-05-06
description: "在 kind 集群中通过 Helm 部署 kube-prometheus-stack，配置 Grafana、Prometheus、Alertmanager 访问入口，并接入示例应用指标。"
image: ''
...
## 第七步：访问 Grafana、Prometheus 和 Alertmanager
