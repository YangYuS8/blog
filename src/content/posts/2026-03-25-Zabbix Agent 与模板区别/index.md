---
title: "Zabbix Agent 与模板区别"
urlSlug: 'zabbix-linux-agent-active-agent2'
published: 2026-03-25
description: "梳理 Zabbix 中 Linux by Zabbix agent、active 模板、zabbix-agent 与 zabbix-agent2 的区别，并给出实际部署选择。"
image: ''
