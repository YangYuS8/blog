---
title: "Zabbix Docker 访问宿主机 Agent2 排查"
urlSlug: 'zabbix-server-docker-agent2-unavailable'
published: 2026-03-24
description: "记录 Zabbix Server 运行在 Docker 中、agent2 运行在宿主机时出现 agent unavailable 的排查过程与访问控制修复方法。"
image: ''
