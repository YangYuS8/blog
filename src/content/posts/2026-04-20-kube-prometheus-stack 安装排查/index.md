---
title: "kube-prometheus-stack 安装排查"
urlSlug: 'kube-prometheus-stack-helm-k3s-proxy-fix'
published: 2026-04-20
description: "记录 k3s 上部署 kube-prometheus-stack 失败的排查过程，最终定位到 k3s/containerd 未继承代理环境导致镜像拉取失败。"
image: ''
tags: ["k3s", "Kubernetes", "Helm", "kube-prometheus-stack", "Prometheus", "Grafana", "故障排查"]
category: "监控与日志"
draft: false 
lang: 'zh_CN'
---
