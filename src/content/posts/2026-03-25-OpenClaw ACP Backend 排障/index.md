---
title: "OpenClaw ACP Backend 排障"
urlSlug: 'openclaw-opencode-acp-backend-troubleshooting'
published: 2026-03-25
description: "记录 OpenClaw 调用 opencode 失败的排查过程，定位 acpx 插件和 acp 顶层配置缺失，并完成 ACP runtime 验证。"
image: ''
