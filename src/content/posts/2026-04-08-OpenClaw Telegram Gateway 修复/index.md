---
title: "OpenClaw Telegram Gateway 修复"
urlSlug: 'openclaw-telegram-gateway-recovery'
published: 2026-04-08
description: "记录 OpenClaw Telegram 扩展缺文件、gateway service 旧版本残留、GEMINI_API_KEY 未进入 systemd 环境等问题的修复过程。"
image: ''
