---
title: "OpenClaw Skills 配置"
urlSlug: 'openclaw-skills-coding-agent-zellij'
published: 2026-03-23
description: "记录 OpenClaw 的 skills、gog、coding-agent 与 zellij 配置过程，包含重复 skill 清理、官方内置版本启用和面板状态修复。"
image: ''
