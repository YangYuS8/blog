---
title: "Linux Mint 修复 Python 包管理"
urlSlug: 'linux-mint-python-package-management-repair'
published: 2026-03-20
description: "记录 Linux Mint 22 上 Python3 核心包损坏后的恢复过程：排查 dpkg 状态、处理 postinst 报错，并将相关依赖恢复到正常状态。"
image: ''
