---
title: "单机 DevOps 实践路线"
urlSlug: 'devops-practice-server-monitoring-logging'
published: 2026-04-13
description: "记录在一台服务器上完成 DevOps 实践任务的路线：SSH 管理、Ansible 初始化、k3s 安装、Prometheus/Grafana 监控与日志服务接入。"
image: ''
