---
title: "OpenCode OpenAI 登录排查"
urlSlug: 'opencode-openai-login-provider-fix'
published: 2026-03-20
description: "记录 OpenCode 登录 OpenAI 后 provider 不出现的排查过程，最终定位到终端代理变量缺少 HTTP_PROXY 与 HTTPS_PROXY。"
image: ''
